...
int main(void)
{
  ...
  SystemClock_Config();																//MX配置时钟，外部时钟源
  ...
  /* USER CODE BEGIN 2 */
	...
	RTC_TimeTypeDef RTC_TimeStructure;												//RTC时间、日期结构体
  ...
  while (1)
  {
	  HAL_GPIO_TogglePin(LED_GPIO_Port,LED_Pin);									//主循环
	  HAL_Delay(500);
	  ...
	  printf("Time:%d", RTC_TimeStructure.Seconds);
